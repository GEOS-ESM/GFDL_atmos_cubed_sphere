...
! </table>
    ...
    use gfdl_lin_cloud_microphys_mod, only: ql_gen, qi_gen, qi0_max, ql_mlt, ql0_max, qi_lim, qs_mlt
    use gfdl_lin_cloud_microphys_mod, only: icloud_f, sat_adj0, t_sub, cld_min
    use gfdl_lin_cloud_microphys_mod, only: tau_r2g, tau_smlt, tau_i2s, tau_v2l, tau_l2v, tau_imlt, tau_l2r
