...
#ifdef OVERLOAD_R4
  use constantsR4_mod,    only: kappa, rdgas, rvgas, grav, cp_air, cp_vapor, pi=>pi_8, radius
#else
  use constants_mod,      only: kappa, rdgas, rvgas, grav, cp_air, cp_vapor, pi=>pi_8, radiusA
#endif
